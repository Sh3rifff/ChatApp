...
import az.sharif.chatapp.adapters.RecentConversationsAdapter;
import az.sharif.chatapp.databinding.FragmentMessageBinding;
...
public class MessageFragment extends Fragment implements ConversionListener {
    ...
    private void setListeners() {
        binding.fabNewChat.setOnClickListener(v ->
                navController.navigate(MessageFragmentDirections.messageToUsers())
        );
    }
    ...
    private void showToast() {
        Toast.makeText(requireContext(), "Unable to update token", Toast.LENGTH_SHORT).show();
    }
    ...
    private void updateToken(String token) {
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token).addOnFailureListener(e -> showToast());
    }
